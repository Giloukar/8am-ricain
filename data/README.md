...
- `ready`: **10,796**;
- `hidden`: **4,011**;
- standard advanced discovery (difficulty 4–5, clean definition/POS): **9,458**;
...
- `Wiktionnaire fr + Lexique 4`: 4,157 ready / 36 hidden;
- `Lexique 4`: 2,255 hidden rows, including 1,897 advanced candidates still pending source review;
...
Current reviewed state: **1,897 pending / 16 approved / 23 rejected**.
