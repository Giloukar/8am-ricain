...
- `ready`: **10,798**;
- `hidden`: **4,009**;
- standard advanced discovery (difficulty 4–5, clean definition/POS): **9,460**;
...
- `Wiktionnaire fr + Lexique 4`: 4,159 ready / 36 hidden;
- `Lexique 4`: 2,253 hidden rows, including 1,890 advanced candidates still pending source review;
...
Current reviewed state: **1,890 pending / 18 approved / 28 rejected**.
