...
- `ready`: **10,808**;
- `hidden`: **3,999**;
- standard advanced discovery (difficulty 4–5, clean definition/POS): **9,470**;
...
- `Wiktionnaire fr + Lexique 4`: 4,169 ready / 36 hidden;
- `Lexique 4`: 2,243 hidden rows, including 1,860 advanced candidates still pending source review;
...
Current reviewed state: **1,797 pending / 28 approved / 111 rejected**.
