...
Source: Lexique / OpenLexicon (CC BY-SA 4.0).
...
def main():
 ...
 with open(src,encoding="utf-8") as h:
  for r in csv.DictReader(h,delimiter="\t"):
   ...
   row={"word":lemma,"lemma":lemma,"pos":pos,"frequency":round(freq,4),"native_score":round(score,2),"difficulty":difficulty,"source":"Lexique383","source_url":URL,"content_status":"candidate"}
